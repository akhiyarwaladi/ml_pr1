...
class NeuralNetwork():
	...
	def train(self, training_set_inputs, training_set_outputs, number_of_training_iterations):
		for iteration in range(number_of_training_iterations):
			...
			layer2_delta_bias = self.learning_rate * layer2_error * self.__sigmoid_derivative(output_from_layer_2)
			...
			layer1_delta_bias = self.learning_rate * layer1_error * self.__sigmoid_derivative(output_from_layer_1)
			...
			self.layer1.synaptic_bias += layer1_delta_bias
			self.layer2.synaptic_weights += layer2_adjustment
			self.layer2.synaptic_bias += layer2_delta_bias

			print ("New Weight:")
			print (self.layer1.synaptic_weights)
			print (self.layer2.synaptic_weights)
			print ("--------------------------")
			print (self.layer1.synaptic_bias.T)
			print (self.layer2.synaptic_bias.T)

			print("================================================================")

		print("----last")
		self.layer1.synaptic_last_bias = self.layer1.synaptic_bias[-1][0]
		self.layer2.synaptic_last_bias = self.layer2.synaptic_bias[-1][0]

	    # The neural network thinks.
	def think(self, inputs):
		output_from_layer1 = self.__sigmoid(dot(inputs, self.layer1.synaptic_weights) + self.layer1.synaptic_bias)
		output_from_layer2 = self.__sigmoid(dot(output_from_layer1, self.layer2.synaptic_weights) + self.layer2.synaptic_bias)
		print("layer2 sebelum Sigmoid")
		print(dot(output_from_layer1, self.layer2.synaptic_weights) + self.layer2.synaptic_bias)
		return output_from_layer1, output_from_layer2

	def predict(self, inputs):
		output_from_layer1 = self.__sigmoid(dot(inputs, self.layer1.synaptic_weights) + self.layer1.synaptic_last_bias)
		output_from_layer2 = self.__sigmoid(dot(output_from_layer1, self.layer2.synaptic_weights) + self.layer2.synaptic_last_bias)
		print("layer2 sebelum Sigmoid")
		print(dot(output_from_layer1, self.layer2.synaptic_weights) + self.layer2.synaptic_bias)
		return output_from_layer1, output_from_layer2
	...
	def print_weights(self):
		...
		print (self.layer1.synaptic_weights)
		print ("----bias1")
		bias1 = self.layer1.synaptic_bias
		#bias1 = array(bias1)
		print (bias1)
		print ("Layer 2 (1 neuron, with 2 inputs):")
		print (self.layer2.synaptic_weights)
		print ("----bias2")
		print (self.layer2.synaptic_bias)
...
if __name__ == "__main__":
	...
	hidden_state, output = neural_network.predict(array([5.1, 3.8]))
	print (output)
